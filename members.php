...
//check if get request userID is numeric  & get his integer value.......

    /*if(isset($_GET['userID']) && is_numeric($_GET['userID'])) {echo intval($_GET['userID']);}else {  echo 0;}*/
    $userID = isset($_GET['userID']) && is_numeric($_GET['userID']) ? intval($_GET['userID']) : 0;
    //check if user exist and select all data base depend on id
    ...
    //chech if there is such id show me the form
    if ($stmt->rowCount() > 0) { ?>
              ...
              <div class="container">
                <form class="form-horizontal">
                  ...
                  <div class="form-group form-group-lg">
                    ...
                    <div class="col-sm-10 col-md-4">
                      <input type="password" name="password" value="<?php echo $row['password']; ?>" class="form-control" autocomplete="new-password">
                    </div>
                  </div>
                  <!--End password field-->
                  <!--Start e-mail field-->
  ...
  //else  in case to there is no such userID show error message ";
}else {
